...
function node_creator(){
    ...
    // (//////////TEST///////////) (Return the path of the nodes of the type "type_of_node") Makes a counter to get the number of nodes inside i

    var existent_nodes = node.getNodes(type_of_node)
    ...
    // Trying without the else statement ////////TEST//////// 
    ...
    for ( var i = 0 ; i < count ; i++){
        ...
        if (test !== -1){
            ...
            if (existent_nodes < 1){
                ...
                final_name = node_name_type + "_" + (existent_nodes.length + 1 )
            ...
            // This line returns undefinded or error when the node is not linked.
